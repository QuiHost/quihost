...
export default function PhoneVerificationBanner() {
  return (
    <div className="bg-[#FFE4CC] rounded-lg overflow-hidden">
      <div className="px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <button className="px-4 py-2 bg-white text-[#FF9500] rounded-lg hover:bg-[#FFF8F0] font-medium text-sm transition-colors">
